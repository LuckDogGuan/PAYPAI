...
export default function VaultSetup({ signerAddress, privateKey, onReady }: VaultSetupProps) {
  ...
  return (
    <div className="bg-zinc-900 p-6 rounded-lg border border-zinc-800">
      <h2 className="text-xl font-semibold mb-4">Create Vault (One Step)</h2>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm text-gray-400 mb-2">Time Window (Hours)</label>
            <input
              type="number"
              value={timeWindow}
        ...
        <div className="bg-zinc-800 p-3 rounded-lg border border-zinc-700">
          <div className="text-xs text-gray-400 mb-1">Executor</div>
        ...
        {step && (
          <div className="text-sm text-blue-300 bg-blue-900/20 p-3 rounded border border-blue-800">
            {step}
          </div>
        )}
